...
const Dashboard = () => {
    ...
    const fetchLatestEvent = async () => {
        try {
            const response = await fetch(`${API_URL}/danger-events/latest`);
            ...
            console.error("최신 위험 이벤트 조회 실패:", error);
        }
    };
        ...
        <>
            <section className={cx("summary-section")}>
                <div className={cx("summary-card")}>
                    ...
                    <div className={cx("card-value-box")}>
                        ...
                        <span className={cx("card-value")}>
                            {latestEvent ? "주의 필요" : "진행 중"}
                        </span>
                    </div>
                    <span className={cx("card-subtext")}>
                        {latestEvent ? "최근 위험 이벤트 발생" : "작업 모니터링 중"}
                    </span>
                </div>
                ...
                <div className={cx("summary-card")}>
                    ...
                    <span className={cx("card-subtext")}>최근 미확인 알림</span>
                </div>
                    ...
                    <div className={cx("card-value-box")}>
                        <div
                            ...
                            style={{
                                ...
                                backgroundColor: latestEvent ? "#fff1f0" : "#f6ffed",
                                padding: "8px",
                                borderRadius: "10px",
                            }}
                        >
                        ...
                        <span className={cx("card-value")}>
                            {latestEvent?.machine_status || "정상"}
                        </span>
                    </div>
                    <span className={cx("card-subtext")}>
                        {latestEvent ? "위험 감지로 설비 정지" : "설비 가동 중"}
                    </span>
                </div>
                ...
                <div className={cx("summary-card")}>
                    ...
                    <span className={cx("card-subtext")}>WinApp 드래그 설정</span>
                </div>
            </section>
                    ...
                    >
                        {latestEvent?.video_path ? (
                            <video
                                ...
                                autoPlay
                                loop
                                src={`${API_URL}/${latestEvent.video_path}`}
                                style={{
                                    width: "100%",
                                    height: "100%",
                                    backgroundColor: "#000",
    ...
    return (
        <div className={cx("dashboard-container")}>
            <aside className={cx("sidebar")}>
                ...
                >
                    <svg width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="#174275" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <nav className={cx("sidebar-nav")}>
                    <div
                        className={cx("nav-item", activeMenu === "dashboard" && "active")}
                        onClick={() => handleMenuClick("dashboard")}
                    >
                        <IconDashboard /> <span>메인 대시보드</span>
                    </div>
                    <div
                        className={cx("nav-item", activeMenu === "monitoring" && "active")}
                        onClick={() => handleMenuClick("monitoring")}
                    >
                        <IconMonitor /> <span>실시간 모니터링</span>
                    </div>
                    <div
                        className={cx("nav-item", activeMenu === "plc" && "active")}
                        onClick={() => handleMenuClick("plc")}
                    >
                        <IconPLC /> <span>설비 수리 관리</span>
                    </div>
                    <div
                        className={cx("nav-item", activeMenu === "alertLog" && "active")}
            ...
            <main className={cx("main-content")}>
                ...
                {activeMenu === "monitoring" && <Monitoring alerts={alerts} latestEvent={latestEvent} />}
